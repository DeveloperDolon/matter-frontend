...
const Login = () => {
    ...
    return (
        <div className="min-h-screen sm:p-10 p-2 bg=[#fafafa]">
            <div className="grid md:grid-cols-2 grid-cols-1 h-full min-h-[calc(100vh-80px)] rounded-3xl overflow-hidden shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Box sx={{ display: 'flex', flexWrap: 'wrap' }}>
                            <div className="w-full">
                                ...
                                }} className="ml-2 block w-full mt-2 login-btn rounded-lg md:text-xl text-lg font-semibold" type="submit">Login</button>
                            </div>
                        </Box>
                    </form>
