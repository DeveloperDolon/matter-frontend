...
const ContactUs = () => {
    ...
    return (
        <div className="bg-gradient-to-b from-purple-600 to-indigo-700 h-96 w-full mb-[500px] mt-52">
                ...
                <div className="top-40 bg-white shadow rounded py-12 lg:px-28 px-8">
                    ...
                    <div className="md:flex items-center mt-12">
                        <div className="md:w-72 flex flex-col">
                            ...
                            <input tabIndex={0} className="text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100" placeholder="Please input  name" />
                        </div>
