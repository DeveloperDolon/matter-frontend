    ...
    return (
        <div>
            ...
            <div className="w-full md:px-10 px-5 md:py-10 py-5">
                ...
                {
                    userRole === "fraud" ?
                        <h3 className="md:text-2xl text-xl title-text font-medium text-red-500">You can&apos;t add any property because you are a fraud! <DoNotDisturbIcon sx={{fontSize: "50px"}}></DoNotDisturbIcon> </h3>
                        :
